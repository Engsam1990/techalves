...
function AdminSidebar() {
  ...
  const navItems = useMemo(() => {
    const baseItems: Array<{ title: string; url: string; icon: LucideIcon; permission?: AdminPermission }> = [
      { title: "Store Dashboard", url: "/admin/dashboard", icon: LayoutDashboard, permission: "dashboard:view" },
      { title: "Products", url: "/admin/products", icon: Package, permission: "products:view" },
      { title: "Inventory", url: "/admin/inventory", icon: Layers, permission: "inventory:view" },
    ...
    const superItems: Array<{ title: string; url: string; icon: LucideIcon; permission?: AdminPermission }> = [
    ...
    return [...superItems, ...baseItems].filter((item) => hasAdminPermission(user, item.permission));
  }, [user]);
