...
-- Procedures
--
CREATE DEFINER=`root`@`localhost` PROCEDURE `techalves_add_column_if_missing` (IN `p_table` VARCHAR(128), IN `p_column` VARCHAR(128), IN `p_definition` TEXT, IN `p_after_column` VARCHAR(128))   BEGIN
  IF EXISTS (
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `techalves_modify_column_if_exists` (IN `p_table` VARCHAR(128), IN `p_column` VARCHAR(128), IN `p_definition` TEXT)   BEGIN
  IF EXISTS (
    SELECT 1 FROM information_schema.COLUMNS
    WHERE TABLE_SCHEMA = DATABASE() AND TABLE_NAME = p_table AND COLUMN_NAME = p_column
  ) THEN
...
INSERT INTO `admin_activity_logs` (`id`, `actor_admin_user_id`, `actor_email`, `action`, `target_admin_user_id`, `target_name`, `target_email`, `details`, `created_at`, `data_entrant`, `entry_date`) VALUES
('1fcf2faa-489b-48f7-aa9c-1a8d3628ef66', '51ed4e51-41a8-11f1-9350-3464a92b0560', 'you@example.com', 'admin_updated', 'af2da808-a9c8-4a0e-95ff-957110216375', 'Samil', 'admin1@techalves.com', '{\"before\":{\"name\":\"Samil\",\"role\":\"admin\",\"isActive\":true,\"permissions\":[\"dashboard:view\",\"products:view\",\"products:create\",\"products:edit\",\"products:edit_basic\",\"products:edit_serials\",\"products:edit_pricing_stock\",\"products:edit_sources\",\"products:edit_images\",\"products:toggle_featured\",\"products:toggle_premium\",\"products:delete\",\"products:archive\",\"inventory:receive_stock\",\"inventory:adjust\",\"pos:use\",\"orders:view\",\"orders:update_status\",\"orders:record_payment\",\"orders:refund\",\"orders:return_items\",\"finance:view\",\"finance:export\",\"expenses:view\",\"expenses:create\",\"sources:view\",\"sources:manage\",\"sourcing_payments:view\",\"catalog:view\",\"catalog:manage\",\"blog:view\",\"blog:manage\",\"messages:view\",\"messages:manage\",\"newsletter:view\",\"newsletter:manage\",\"customers:view\",\"customers:manage\",\"analytics:view\",\"uploads:manage\",\"products:view_all\",\"inventory:view\"]},\"after\":{\"name\":\"Samil\",\"role\":\"admin\",\"isActive\":true,\"permissions\":[\"dashboard:view\",\"products:view\",\"products:create\",\"products:edit\",\"products:edit_basic\",\"products:edit_serials\",\"products:edit_pricing_stock\",\"products:edit_sources\",\"products:edit_images\",\"products:toggle_featured\",\"products:toggle_premium\",\"products:delete\",\"products:archive\",\"inventory:receive_stock\",\"inventory:adjust\",\"pos:use\",\"orders:view\",\"orders:update_status\",\"orders:record_payment\",\"orders:refund\",\"orders:return_items\",\"finance:view\",\"finance:export\",\"expenses:view\",\"expenses:create\",\"sources:view\",\"sources:manage\",\"sourcing_payments:view\",\"catalog:view\",\"catalog:manage\",\"blog:view\",\"blog:manage\",\"messages:view\",\"messages:manage\",\"newsletter:view\",\"newsletter:manage\",\"customers:view\",\"customers:manage\",\"analytics:view\",\"uploads:manage\",\"products:view_all\",\"inventory:view\",\"inventory:view_overview\",\"inventory:view_stock_health\",\"inventory:view_categories\",\"inventory:view_movements\",\"inventory:view_product_flow\"]}}', '2026-05-01 12:10:52.304', '51ed4e51-41a8-11f1-9350-3464a92b0560', '2026-05-01 12:10:52.304'),
('6f0afc0c-6be8-4b95-80c5-5eba8f4b02d8', '51ed4e51-41a8-11f1-9350-3464a92b0560', 'you@example.com', 'admin_updated', 'af2da808-a9c8-4a0e-95ff-957110216375', 'Samil', 'admin1@techalves.com', '{\"before\":{\"name\":\"Samil\",\"role\":\"admin\",\"isActive\":true,\"permissions\":[\"dashboard:view\",\"products:view\",\"products:create\",\"products:edit\",\"products:edit_basic\",\"products:edit_serials\",\"products:edit_pricing_stock\",\"products:edit_sources\",\"products:edit_images\",\"products:toggle_featured\",\"products:toggle_premium\",\"products:delete\",\"products:archive\",\"inventory:view\",\"inventory:receive_stock\",\"inventory:adjust\",\"pos:use\",\"orders:view\",\"orders:update_status\",\"orders:record_payment\",\"orders:refund\",\"orders:return_items\",\"finance:view\",\"finance:export\",\"expenses:view\",\"expenses:create\",\"expenses:edit\",\"expenses:void\",\"sources:view\",\"sources:manage\",\"sourcing_payments:view\",\"sourcing_payments:update\",\"catalog:view\",\"catalog:manage\",\"blog:view\",\"blog:manage\",\"messages:view\",\"messages:manage\",\"newsletter:view\",\"newsletter:manage\",\"customers:view\",\"customers:manage\",\"analytics:view\",\"uploads:manage\"]},\"after\":{\"name\":\"Samil\",\"role\":\"admin\",\"isActive\":true,\"permissions\":[\"dashboard:view\",\"products:view\",\"products:create\",\"products:edit\",\"products:edit_basic\",\"products:edit_serials\",\"products:edit_pricing_stock\",\"products:edit_sources\",\"products:edit_images\",\"products:toggle_featured\",\"products:toggle_premium\",\"products:delete\",\"products:archive\",\"inventory:view\",\"inventory:receive_stock\",\"inventory:adjust\",\"pos:use\",\"orders:view\",\"orders:update_status\",\"orders:record_payment\",\"orders:refund\",\"orders:return_items\",\"finance:view\",\"finance:export\",\"expenses:view\",\"expenses:create\",\"sources:view\",\"sources:manage\",\"sourcing_payments:view\",\"sourcing_payments:update\",\"catalog:view\",\"catalog:manage\",\"blog:view\",\"blog:manage\",\"messages:view\",\"messages:manage\",\"newsletter:view\",\"newsletter:manage\",\"customers:view\",\"customers:manage\",\"analytics:view\",\"uploads:manage\"]}}', '2026-05-01 09:18:38.445', '51ed4e51-41a8-11f1-9350-3464a92b0560', '2026-05-01 09:18:38.445'),
('774d43ac-cd9f-4086-89e2-f7c77d6b67b3', '51ed4e51-41a8-11f1-9350-3464a92b0560', 'you@example.com', 'admin_updated', 'af2da808-a9c8-4a0e-95ff-957110216375', 'Samil', 'admin1@techalves.com', '{\"before\":{\"name\":\"Samil\",\"role\":\"admin\",\"isActive\":true,\"permissions\":[\"dashboard:view\",\"products:view\",\"products:create\",\"products:edit\",\"products:edit_basic\",\"products:edit_serials\",\"products:edit_pricing_stock\",\"products:edit_sources\",\"products:edit_images\",\"products:toggle_featured\",\"products:toggle_premium\",\"products:delete\",\"products:archive\",\"inventory:receive_stock\",\"inventory:adjust\",\"pos:use\",\"orders:view\",\"orders:update_status\",\"orders:record_payment\",\"orders:refund\",\"orders:return_items\",\"finance:view\",\"finance:export\",\"expenses:view\",\"expenses:create\",\"sources:view\",\"sources:manage\",\"sourcing_payments:view\",\"catalog:view\",\"catalog:manage\",\"blog:view\",\"blog:manage\",\"messages:view\",\"messages:manage\",\"newsletter:view\",\"newsletter:manage\",\"customers:view\",\"customers:manage\",\"analytics:view\",\"uploads:manage\",\"products:view_all\",\"inventory:view\",\"inventory:view_overview\",\"inventory:view_stock_health\",\"inventory:view_categories\",\"inventory:view_movements\",\"inventory:view_product_flow\"]},\"after\":{\"name\":\"Samil\",\"role\":\"admin\",\"isActive\":false,\"permissions\":[\"dashboard:view\",\"products:view\",\"products:create\",\"products:edit\",\"products:edit_basic\",\"products:edit_serials\",\"products:edit_pricing_stock\",\"products:edit_sources\",\"products:edit_images\",\"products:toggle_featured\",\"products:toggle_premium\",\"products:delete\",\"products:archive\",\"inventory:receive_stock\",\"inventory:adjust\",\"pos:use\",\"orders:view\",\"orders:update_status\",\"orders:record_payment\",\"orders:refund\",\"orders:return_items\",\"finance:view\",\"finance:export\",\"expenses:view\",\"expenses:create\",\"sources:view\",\"sources:manage\",\"sourcing_payments:view\",\"catalog:view\",\"catalog:manage\",\"blog:view\",\"blog:manage\",\"messages:view\",\"messages:manage\",\"newsletter:view\",\"newsletter:manage\",\"customers:view\",\"customers:manage\",\"analytics:view\",\"uploads:manage\",\"products:view_all\",\"inventory:view\",\"inventory:view_overview\",\"inventory:view_stock_health\",\"inventory:view_categories\",\"inventory:view_movements\",\"inventory:view_product_flow\"]}}', '2026-05-01 12:47:13.243', '51ed4e51-41a8-11f1-9350-3464a92b0560', '2026-05-01 12:47:13.243'),
('8d0b83ca-3f89-4b94-a006-3a5964a5d6ca', '51ed4e51-41a8-11f1-9350-3464a92b0560', 'you@example.com', 'admin_updated', 'af2da808-a9c8-4a0e-95ff-957110216375', 'Samil', 'admin1@techalves.com', '{\"before\":{\"name\":\"Samil\",\"role\":\"admin\",\"isActive\":true,\"permissions\":[\"dashboard:view\",\"products:view\",\"products:create\",\"products:edit\",\"products:edit_basic\",\"products:edit_serials\",\"products:edit_pricing_stock\",\"products:edit_sources\",\"products:edit_images\",\"products:toggle_featured\",\"products:toggle_premium\",\"products:delete\",\"products:archive\",\"inventory:receive_stock\",\"inventory:adjust\",\"pos:use\",\"orders:view\",\"orders:update_status\",\"orders:record_payment\",\"orders:refund\",\"orders:return_items\",\"finance:view\",\"finance:export\",\"expenses:view\",\"expenses:create\",\"sources:view\",\"sources:manage\",\"sourcing_payments:view\",\"catalog:view\",\"catalog:manage\",\"blog:view\",\"blog:manage\",\"messages:view\",\"messages:manage\",\"newsletter:view\",\"newsletter:manage\",\"customers:view\",\"customers:manage\",\"analytics:view\",\"uploads:manage\",\"products:view_all\",\"inventory:view\",\"inventory:view_overview\",\"inventory:view_stock_health\",\"inventory:view_categories\",\"inventory:view_movements\",\"inventory:view_product_flow\",\"inventory:view_metrics\"]},\"after\":{\"name\":\"Samil\",\"role\":\"admin\",\"isActive\":true,\"permissions\":[\"dashboard:view\",\"products:view\",\"products:create\",\"products:edit\",\"products:edit_basic\",\"products:edit_serials\",\"products:edit_pricing_stock\",\"products:edit_sources\",\"products:edit_images\",\"products:toggle_featured\",\"products:toggle_premium\",\"products:delete\",\"products:archive\",\"inventory:receive_stock\",\"inventory:adjust\",\"pos:use\",\"orders:view\",\"orders:update_status\",\"orders:record_payment\",\"orders:refund\",\"orders:return_items\",\"finance:view\",\"finance:export\",\"expenses:view\",\"expenses:create\",\"sources:view\",\"sources:manage\",\"sourcing_payments:view\",\"catalog:view\",\"catalog:manage\",\"blog:view\",\"blog:manage\",\"messages:view\",\"messages:manage\",\"newsletter:view\",\"newsletter:manage\",\"customers:view\",\"customers:manage\",\"analytics:view\",\"uploads:manage\",\"products:view_all\",\"inventory:view\",\"inventory:view_stock_health\",\"inventory:view_categories\",\"inventory:view_movements\",\"inventory:view_product_flow\",\"inventory:view_metrics\"]}}', '2026-05-01 12:47:43.636', '51ed4e51-41a8-11f1-9350-3464a92b0560', '2026-05-01 12:47:43.636'),
('a7646b8d-3584-411a-839e-fa117da66cb5', '51ed4e51-41a8-11f1-9350-3464a92b0560', 'you@example.com', 'admin_updated', 'af2da808-a9c8-4a0e-95ff-957110216375', 'Samil', 'admin1@techalves.com', '{\"before\":{\"name\":\"Samil\",\"role\":\"admin\",\"isActive\":true,\"permissions\":[\"dashboard:view\",\"products:view\",\"products:create\",\"products:edit\",\"products:edit_basic\",\"products:edit_serials\",\"products:edit_pricing_stock\",\"products:edit_sources\",\"products:edit_images\",\"products:toggle_featured\",\"products:toggle_premium\",\"products:delete\",\"products:archive\",\"inventory:receive_stock\",\"inventory:adjust\",\"pos:use\",\"orders:view\",\"orders:update_status\",\"orders:record_payment\",\"orders:refund\",\"orders:return_items\",\"finance:view\",\"finance:export\",\"expenses:view\",\"expenses:create\",\"sources:view\",\"sources:manage\",\"sourcing_payments:view\",\"catalog:view\",\"catalog:manage\",\"blog:view\",\"blog:manage\",\"messages:view\",\"messages:manage\",\"newsletter:view\",\"newsletter:manage\",\"customers:view\",\"customers:manage\",\"analytics:view\",\"uploads:manage\",\"products:view_all\",\"inventory:view\",\"inventory:view_stock_health\",\"inventory:view_categories\",\"inventory:view_movements\",\"inventory:view_product_flow\",\"inventory:view_metrics\"]},\"after\":{\"name\":\"Samil\",\"role\":\"admin\",\"isActive\":true,\"permissions\":[\"dashboard:view\",\"products:view\",\"products:create\",\"products:edit\",\"products:edit_basic\",\"products:edit_serials\",\"products:edit_pricing_stock\",\"products:edit_sources\",\"products:edit_images\",\"products:toggle_featured\",\"products:toggle_premium\",\"products:delete\",\"products:archive\",\"inventory:receive_stock\",\"inventory:adjust\",\"pos:use\",\"orders:view\",\"orders:update_status\",\"orders:record_payment\",\"orders:refund\",\"orders:return_items\",\"finance:view\",\"finance:export\",\"expenses:view\",\"expenses:create\",\"sources:view\",\"sources:manage\",\"sourcing_payments:view\",\"catalog:view\",\"catalog:manage\",\"blog:view\",\"blog:manage\",\"messages:view\",\"messages:manage\",\"newsletter:view\",\"newsletter:manage\",\"customers:view\",\"customers:manage\",\"analytics:view\",\"uploads:manage\",\"products:view_all\",\"inventory:view\",\"inventory:view_stock_health\",\"inventory:view_categories\",\"inventory:view_movements\",\"inventory:view_product_flow\",\"inventory:view_metrics\",\"dashboard:view_product_stats\",\"dashboard:view_inquiries\"]}}', '2026-05-01 12:51:54.709', '51ed4e51-41a8-11f1-9350-3464a92b0560', '2026-05-01 12:51:54.709'),
('c576dccc-8215-4f59-8fe4-fd8618838646', '51ed4e51-41a8-11f1-9350-3464a92b0560', 'you@example.com', 'admin_created', 'af2da808-a9c8-4a0e-95ff-957110216375', 'Samil', 'admin1@techalves.com', '{\"role\":\"admin\",\"permissions\":[\"dashboard:view\",\"products:view\",\"products:create\",\"products:edit\",\"products:edit_basic\",\"products:edit_serials\",\"products:edit_pricing_stock\",\"products:edit_sources\",\"products:edit_images\",\"products:toggle_featured\",\"products:toggle_premium\",\"inventory:view\",\"inventory:receive_stock\",\"inventory:adjust\",\"pos:use\",\"orders:view\",\"orders:update_status\",\"orders:record_payment\",\"orders:refund\",\"orders:return_items\",\"finance:view\",\"finance:export\",\"expenses:view\",\"expenses:create\",\"sources:view\",\"sources:manage\",\"sourcing_payments:view\",\"sourcing_payments:update\",\"catalog:view\",\"catalog:manage\",\"blog:view\",\"blog:manage\",\"messages:view\",\"messages:manage\",\"newsletter:view\",\"newsletter:manage\",\"customers:view\",\"customers:manage\",\"analytics:view\",\"uploads:manage\"],\"permissionCount\":40,\"isActive\":true,\"source\":\"create_admin\"}', '2026-05-01 08:35:16.996', '51ed4e51-41a8-11f1-9350-3464a92b0560', '2026-05-01 08:35:16.996'),
('cb9f66a3-a71c-4140-b8eb-de4035504d68', '51ed4e51-41a8-11f1-9350-3464a92b0560', 'you@example.com', 'admin_updated', 'af2da808-a9c8-4a0e-95ff-957110216375', 'Samil', 'admin1@techalves.com', '{\"before\":{\"name\":\"Samil\",\"role\":\"admin\",\"isActive\":true,\"permissions\":[\"dashboard:view\",\"products:view\",\"products:create\",\"products:edit\",\"products:edit_basic\",\"products:edit_serials\",\"products:edit_pricing_stock\",\"products:edit_sources\",\"products:edit_images\",\"products:toggle_featured\",\"products:toggle_premium\",\"products:delete\",\"products:archive\",\"inventory:view\",\"inventory:receive_stock\",\"inventory:adjust\",\"pos:use\",\"orders:view\",\"orders:update_status\",\"orders:record_payment\",\"orders:refund\",\"orders:return_items\",\"finance:view\",\"finance:export\",\"expenses:view\",\"expenses:create\",\"sources:view\",\"sources:manage\",\"sourcing_payments:view\",\"sourcing_payments:update\",\"catalog:view\",\"catalog:manage\",\"blog:view\",\"blog:manage\",\"messages:view\",\"messages:manage\",\"newsletter:view\",\"newsletter:manage\",\"customers:view\",\"customers:manage\",\"analytics:view\",\"uploads:manage\"]},\"after\":{\"name\":\"Samil\",\"role\":\"admin\",\"isActive\":true,\"permissions\":[\"dashboard:view\",\"products:view\",\"products:create\",\"products:edit\",\"products:edit_basic\",\"products:edit_serials\",\"products:edit_pricing_stock\",\"products:edit_sources\",\"products:edit_images\",\"products:toggle_featured\",\"products:toggle_premium\",\"products:delete\",\"products:archive\",\"inventory:view\",\"inventory:receive_stock\",\"inventory:adjust\",\"pos:use\",\"orders:view\",\"orders:update_status\",\"orders:record_payment\",\"orders:refund\",\"orders:return_items\",\"finance:view\",\"finance:export\",\"expenses:view\",\"expenses:create\",\"sources:view\",\"sources:manage\",\"sourcing_payments:view\",\"catalog:view\",\"catalog:manage\",\"blog:view\",\"blog:manage\",\"messages:view\",\"messages:manage\",\"newsletter:view\",\"newsletter:manage\",\"customers:view\",\"customers:manage\",\"analytics:view\",\"uploads:manage\"]}}', '2026-05-01 09:34:22.219', '51ed4e51-41a8-11f1-9350-3464a92b0560', '2026-05-01 09:34:22.219'),
('d79fe6c5-b123-44a1-95d7-4613ad9a219c', '51ed4e51-41a8-11f1-9350-3464a92b0560', 'you@example.com', 'admin_updated', 'af2da808-a9c8-4a0e-95ff-957110216375', 'Samil', 'admin1@techalves.com', '{\"before\":{\"name\":\"Samil\",\"role\":\"admin\",\"isActive\":true,\"permissions\":[\"dashboard:view\",\"products:view\",\"products:create\",\"products:edit\",\"products:edit_basic\",\"products:edit_serials\",\"products:edit_pricing_stock\",\"products:edit_sources\",\"products:edit_images\",\"products:toggle_featured\",\"products:toggle_premium\",\"products:delete\",\"products:archive\",\"inventory:view\",\"inventory:receive_stock\",\"inventory:adjust\",\"pos:use\",\"orders:view\",\"orders:update_status\",\"orders:record_payment\",\"orders:refund\",\"orders:return_items\",\"finance:view\",\"finance:export\",\"expenses:view\",\"expenses:create\",\"sources:view\",\"sources:manage\",\"sourcing_payments:view\",\"catalog:view\",\"catalog:manage\",\"blog:view\",\"blog:manage\",\"messages:view\",\"messages:manage\",\"newsletter:view\",\"newsletter:manage\",\"customers:view\",\"customers:manage\",\"analytics:view\",\"uploads:manage\"]},\"after\":{\"name\":\"Samil\",\"role\":\"admin\",\"isActive\":true,\"permissions\":[\"dashboard:view\",\"products:view\",\"products:create\",\"products:edit\",\"products:edit_basic\",\"products:edit_serials\",\"products:edit_pricing_stock\",\"products:edit_sources\",\"products:edit_images\",\"products:toggle_featured\",\"products:toggle_premium\",\"products:delete\",\"products:archive\",\"inventory:receive_stock\",\"inventory:adjust\",\"pos:use\",\"orders:view\",\"orders:update_status\",\"orders:record_payment\",\"orders:refund\",\"orders:return_items\",\"finance:view\",\"finance:export\",\"expenses:view\",\"expenses:create\",\"sources:view\",\"sources:manage\",\"sourcing_payments:view\",\"catalog:view\",\"catalog:manage\",\"blog:view\",\"blog:manage\",\"messages:view\",\"messages:manage\",\"newsletter:view\",\"newsletter:manage\",\"customers:view\",\"customers:manage\",\"analytics:view\",\"uploads:manage\",\"products:view_all\",\"inventory:view\"]}}', '2026-05-01 11:02:03.906', '51ed4e51-41a8-11f1-9350-3464a92b0560', '2026-05-01 11:02:03.906'),
('e8a7d1d8-29bd-409e-b268-df13075c239d', '51ed4e51-41a8-11f1-9350-3464a92b0560', 'you@example.com', 'admin_updated', 'af2da808-a9c8-4a0e-95ff-957110216375', 'Samil', 'admin1@techalves.com', '{\"before\":{\"name\":\"Samil\",\"role\":\"admin\",\"isActive\":false,\"permissions\":[\"dashboard:view\",\"products:view\",\"products:create\",\"products:edit\",\"products:edit_basic\",\"products:edit_serials\",\"products:edit_pricing_stock\",\"products:edit_sources\",\"products:edit_images\",\"products:toggle_featured\",\"products:toggle_premium\",\"products:delete\",\"products:archive\",\"inventory:receive_stock\",\"inventory:adjust\",\"pos:use\",\"orders:view\",\"orders:update_status\",\"orders:record_payment\",\"orders:refund\",\"orders:return_items\",\"finance:view\",\"finance:export\",\"expenses:view\",\"expenses:create\",\"sources:view\",\"sources:manage\",\"sourcing_payments:view\",\"catalog:view\",\"catalog:manage\",\"blog:view\",\"blog:manage\",\"messages:view\",\"messages:manage\",\"newsletter:view\",\"newsletter:manage\",\"customers:view\",\"customers:manage\",\"analytics:view\",\"uploads:manage\",\"products:view_all\",\"inventory:view\",\"inventory:view_overview\",\"inventory:view_stock_health\",\"inventory:view_categories\",\"inventory:view_movements\",\"inventory:view_product_flow\"]},\"after\":{\"name\":\"Samil\",\"role\":\"admin\",\"isActive\":true,\"permissions\":[\"dashboard:view\",\"products:view\",\"products:create\",\"products:edit\",\"products:edit_basic\",\"products:edit_serials\",\"products:edit_pricing_stock\",\"products:edit_sources\",\"products:edit_images\",\"products:toggle_featured\",\"products:toggle_premium\",\"products:delete\",\"products:archive\",\"inventory:receive_stock\",\"inventory:adjust\",\"pos:use\",\"orders:view\",\"orders:update_status\",\"orders:record_payment\",\"orders:refund\",\"orders:return_items\",\"finance:view\",\"finance:export\",\"expenses:view\",\"expenses:create\",\"sources:view\",\"sources:manage\",\"sourcing_payments:view\",\"catalog:view\",\"catalog:manage\",\"blog:view\",\"blog:manage\",\"messages:view\",\"messages:manage\",\"newsletter:view\",\"newsletter:manage\",\"customers:view\",\"customers:manage\",\"analytics:view\",\"uploads:manage\",\"products:view_all\",\"inventory:view\",\"inventory:view_overview\",\"inventory:view_stock_health\",\"inventory:view_categories\",\"inventory:view_movements\",\"inventory:view_product_flow\"]}}', '2026-05-01 12:47:18.441', '51ed4e51-41a8-11f1-9350-3464a92b0560', '2026-05-01 12:47:18.441'),
('f7a2e66d-c565-473c-8b15-9e98a5b3fe60', '51ed4e51-41a8-11f1-9350-3464a92b0560', 'you@example.com', 'admin_updated', 'af2da808-a9c8-4a0e-95ff-957110216375', 'Samil', 'admin1@techalves.com', '{\"before\":{\"name\":\"Samil\",\"role\":\"admin\",\"isActive\":true,\"permissions\":[\"dashboard:view\",\"products:view\",\"products:create\",\"products:edit\",\"products:edit_basic\",\"products:edit_serials\",\"products:edit_pricing_stock\",\"products:edit_sources\",\"products:edit_images\",\"products:toggle_featured\",\"products:toggle_premium\",\"products:delete\",\"products:archive\",\"inventory:receive_stock\",\"inventory:adjust\",\"pos:use\",\"orders:view\",\"orders:update_status\",\"orders:record_payment\",\"orders:refund\",\"orders:return_items\",\"finance:view\",\"finance:export\",\"expenses:view\",\"expenses:create\",\"sources:view\",\"sources:manage\",\"sourcing_payments:view\",\"catalog:view\",\"catalog:manage\",\"blog:view\",\"blog:manage\",\"messages:view\",\"messages:manage\",\"newsletter:view\",\"newsletter:manage\",\"customers:view\",\"customers:manage\",\"analytics:view\",\"uploads:manage\",\"products:view_all\",\"inventory:view\",\"inventory:view_overview\",\"inventory:view_stock_health\",\"inventory:view_categories\",\"inventory:view_movements\",\"inventory:view_product_flow\"]},\"after\":{\"name\":\"Samil\",\"role\":\"admin\",\"isActive\":true,\"permissions\":[\"dashboard:view\",\"products:view\",\"products:create\",\"products:edit\",\"products:edit_basic\",\"products:edit_serials\",\"products:edit_pricing_stock\",\"products:edit_sources\",\"products:edit_images\",\"products:toggle_featured\",\"products:toggle_premium\",\"products:delete\",\"products:archive\",\"inventory:receive_stock\",\"inventory:adjust\",\"pos:use\",\"orders:view\",\"orders:update_status\",\"orders:record_payment\",\"orders:refund\",\"orders:return_items\",\"finance:view\",\"finance:export\",\"expenses:view\",\"expenses:create\",\"sources:view\",\"sources:manage\",\"sourcing_payments:view\",\"catalog:view\",\"catalog:manage\",\"blog:view\",\"blog:manage\",\"messages:view\",\"messages:manage\",\"newsletter:view\",\"newsletter:manage\",\"customers:view\",\"customers:manage\",\"analytics:view\",\"uploads:manage\",\"products:view_all\",\"inventory:view\",\"inventory:view_overview\",\"inventory:view_stock_health\",\"inventory:view_categories\",\"inventory:view_movements\",\"inventory:view_product_flow\",\"inventory:view_metrics\"]}}', '2026-05-01 12:47:28.570', '51ed4e51-41a8-11f1-9350-3464a92b0560', '2026-05-01 12:47:28.570');
...
('af2da808-a9c8-4a0e-95ff-957110216375', 'admin1@techalves.com', '$2a$12$iboOBribzrUytv4cR6pWy.iCKDfdpNSo6SQiHvFfoDm3ubDWBJZoy', 'Samil', 'admin', '[\"dashboard:view\",\"products:view\",\"products:create\",\"products:edit\",\"products:edit_basic\",\"products:edit_serials\",\"products:edit_pricing_stock\",\"products:edit_sources\",\"products:edit_images\",\"products:toggle_featured\",\"products:toggle_premium\",\"products:delete\",\"products:archive\",\"inventory:receive_stock\",\"inventory:adjust\",\"pos:use\",\"orders:view\",\"orders:update_status\",\"orders:record_payment\",\"orders:refund\",\"orders:return_items\",\"finance:view\",\"finance:export\",\"expenses:view\",\"expenses:create\",\"sources:view\",\"sources:manage\",\"sourcing_payments:view\",\"catalog:view\",\"catalog:manage\",\"blog:view\",\"blog:manage\",\"messages:view\",\"messages:manage\",\"newsletter:view\",\"newsletter:manage\",\"customers:view\",\"customers:manage\",\"analytics:view\",\"uploads:manage\",\"products:view_all\",\"inventory:view\",\"inventory:view_stock_health\",\"inventory:view_categories\",\"inventory:view_movements\",\"inventory:view_product_flow\",\"inventory:view_metrics\",\"dashboard:view_product_stats\",\"dashboard:view_inquiries\"]', 1, '2026-05-01 08:35:16.649', '2026-05-01 12:51:54.703', NULL, '2026-05-01 08:35:16.649');
...
('pos-walkin-customer', 'Walk-in Customer', 'pos-walkin@techalves.local', 'POS', '', 1, '2026-04-27 18:30:07.678', '2026-05-01 12:27:09.004', NULL, '2026-04-27 21:30:07.848');
...
('ddbf0f23-dc80-43fb-9c48-69429d01db88', 'Sale/order expense for Hikvision 4-Channel CCTV Kit on #055A2279 — POS Walk-in Customer — KSh 28,999\ni gave client fare', 'sale', 500.00, '2026-05-01', '055a2279-26f0-4554-a285-35b8f37d1614', 'af2da808-a9c8-4a0e-95ff-957110216375', '2026-05-01 11:43:55.404', '2026-05-01 11:43:55.404', '2026-05-01 11:43:55.404', 'expense-cat-sale', 'e51b5275-8c0a-420e-90fc-7a8891a338df', NULL, 'f66fffa4-426c-49a7-a209-2123505e75ed', 'paid', 'cash', NULL, 'Sale/order expense for Hikvision 4-Channel CCTV Kit on #055A2279 — POS Walk-in Customer — KSh 28,999\ni gave client fare', 'af2da808-a9c8-4a0e-95ff-957110216375');
...
('5bc1b4f6-a37a-4fbf-b761-62820b668c46', 'f491f4ce-8db2-4bd7-93b5-0882deeb9b08', '314f9fff-b6dc-49fe-8144-c02e56b00282', '51ed4e51-41a8-11f1-9350-3464a92b0560', 'pos_sale', -1, 20, 19, 'POS sale (cash)', '2026-05-01 12:27:09.004', '51ed4e51-41a8-11f1-9350-3464a92b0560', '2026-05-01 12:27:09.004'),
...
('c747ebe9-3cf0-4f7f-b2ee-e22a279cc04c', 'e51b5275-8c0a-420e-90fc-7a8891a338df', '055a2279-26f0-4554-a285-35b8f37d1614', 'af2da808-a9c8-4a0e-95ff-957110216375', 'pos_sale', -1, 21, 20, 'POS sale (cash)', '2026-05-01 11:41:01.373', 'af2da808-a9c8-4a0e-95ff-957110216375', '2026-05-01 11:41:01.373'),
...
('055a2279-26f0-4554-a285-35b8f37d1614', 'pos-walkin-customer', 'completed', 'paid', 'cash', NULL, 28999, 0.00, 0, 1, 0.00, 0.00, 28999, 'POS Walk-in Customer', 'POS', '', 'In-store POS sale', 'POS sale recorded by admin1@techalves.com', 'af2da808-a9c8-4a0e-95ff-957110216375', '2026-05-01 11:41:01.373', '2026-05-01 11:41:01.373', 'af2da808-a9c8-4a0e-95ff-957110216375', '2026-05-01 11:41:01.373'),
('314f9fff-b6dc-49fe-8144-c02e56b00282', 'pos-walkin-customer', 'completed', 'paid', 'cash', NULL, 44030, 0.00, 0, 1, 0.00, 30.00, 44030, 'POS Walk-in Customer', 'POS', '', 'In-store POS sale', 'POS sale recorded by you@example.com', '51ed4e51-41a8-11f1-9350-3464a92b0560', '2026-05-01 12:27:09.004', '2026-05-01 12:27:09.004', '51ed4e51-41a8-11f1-9350-3464a92b0560', '2026-05-01 12:27:09.004'),
...
('4f5b5af7-a222-4604-9674-493e2d35bd14', '314f9fff-b6dc-49fe-8144-c02e56b00282', 'f491f4ce-8db2-4bd7-93b5-0882deeb9b08', 'HP ProBook 450 G7', 'HP', NULL, 'e6022611-c3e0-46e9-9aad-fc4b0a64e7f3', 'Samuel Muthui', 30000, 30000, 44000, 44000, 0.00, 0, '[]', 1, 44000, 44000, '51ed4e51-41a8-11f1-9350-3464a92b0560', '2026-05-01 12:27:09.004'),
...
('f66fffa4-426c-49a7-a209-2123505e75ed', '055a2279-26f0-4554-a285-35b8f37d1614', 'e51b5275-8c0a-420e-90fc-7a8891a338df', 'Hikvision 4-Channel CCTV Kit', 'Hikvision', 'kas123', NULL, NULL, 0, 0, 28999, 28999, 0.00, 0, '[\"dsfdssdsd\"]', 1, 28999, 28999, 'af2da808-a9c8-4a0e-95ff-957110216375', '2026-05-01 11:41:01.373');
...
('e51b5275-8c0a-420e-90fc-7a8891a338df', 'hikvision-4ch-cctv-kit', 'Hikvision 4-Channel CCTV Kit', '1d1566d3-e978-46f7-b888-538637b27c77', '4738e2bc-31f0-11f1-a5c8-3464a92b0560', '471e3ce6-31f0-11f1-a5c8-3464a92b0560', NULL, 'kas123', 28999, NULL, 'new', 'Complete 4-channel security camera system with night vision and remote viewing.', '{}', '12 months warranty', 1, 1, 0, 4.4, 22, '[\"/uploads/1777309579730-8a4e7838-1777294398883-fa6682d7-61wy9aaelsl.jpg\",\"/uploads/1777309580059-369cac17-1777304158381-e5d3781b-61wy9aaelsl.jpg\"]', '2026-03-19 14:33:12.488', 20, 21, '[\"dsfdssdsd\",\"34reerer\",\"34444f\"]', NULL, '51ed4e51-41a8-11f1-9350-3464a92b0560', NULL, NULL, NULL, 0.00, 'pending', 'catalog', 1, 'pay_later', NULL, NULL, NULL, '2026-04-25 14:45:41.382'),
...
('2026-04-27_fix_pos_paid_totals', '2026-04-27_fix_pos_paid_totals.sql', '2026-05-01 11:57:16');
...
ALTER TABLE `schema_migrations`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `schema_migrations_filename_unique` (`filename`);
